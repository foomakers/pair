const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/page-D0TAxnmv.js","assets/jsx-runtime-C0mGjcXq.js","assets/page-DNqq_PFq.js"])))=>i.map(i=>d[i]);
...
const _Users_gianlucacarucci_projects_pair_apps_website_app__landing__page = () => __vitePreload(() => import('./page-D0TAxnmv.js'),true              ?__vite__mapDeps([0,1]):void 0).then((mod) => mod.default);
const _Users_gianlucacarucci_projects_pair_apps_website_app_privacy_page = () => __vitePreload(() => import('./page-DNqq_PFq.js'),true              ?__vite__mapDeps([2,1]):void 0).then((mod) => mod.default);
__pwRegistry.initialize({ _Users_gianlucacarucci_projects_pair_apps_website_app__landing__page,
  _Users_gianlucacarucci_projects_pair_apps_website_app_privacy_page });

export { getDefaultExportFromCjs as g };
//# sourceMappingURL=index-uLnGPXay.js.map
