    ...
    <main className="mx-auto max-w-2xl px-6 py-16 font-sans text-pair-text-light dark:text-pair-text-dark">
      ...
      <section className="mt-8 space-y-4">
        ...
        <ul className="list-disc pl-6 space-y-1">
          ...
          <li>
            Each page visit is treated as a new anonymous session — we cannot
      ...
      <section className="mt-8 space-y-4">
        ...
        <ul className="list-disc pl-6 space-y-1">
          ...
          <li>
            Web Vitals performance metrics (LCP, CLS, INP) — anonymous,
            aggregated
          </li>
      ...
      <section className="mt-8 space-y-4">
        ...
        <p>
          Analytics data is processed by PostHog (PostHog Inc.). PostHog is
          hosted in the EU. No data is shared with third parties.
        </p>
      </section>
      ...
      <section className="mt-8 space-y-4">
        ...
        <p>
          You can block all analytics tracking by using any ad blocker (e.g.,
          uBlock Origin). The site functions fully without analytics.
        </p>
      </section>
