...
Generated locally when you run `pair-cli install` or `pair-cli update`. Summarizes the installed Knowledge Base: adoption files, guidelines, how-to guides, and skills. This gives an AI assistant a map of your project's pair setup without scanning the entire `.pair/` directory.
...
- [Architecture](.pair/adoption/tech/architecture.md)
...
| `pair-cli install` | `.pair/llms.txt` — generated from installed KB content |
| `pair-cli update` | `.pair/llms.txt` — regenerated to reflect updated KB |
