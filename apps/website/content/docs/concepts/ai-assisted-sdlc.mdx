...
Each level has specific [process guides](/docs/developer-journey) that the AI follows. The guides reference your [adoption files](/docs/concepts/adoption-files), so the AI's output is always aligned with your decisions.
...
| Unstructured process | 9 how-to guides define every step from idea to merge |
