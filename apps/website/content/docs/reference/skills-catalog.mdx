...
| Skill | Command | Description |
| ----- | ------- | ----------- |
| **record-decision** | `/pair-capability-record-decision` | Records an architectural (ADR), non-architectural (ADL), or domain (DDR) decision. Updates adoption files or syncs the context map. |
