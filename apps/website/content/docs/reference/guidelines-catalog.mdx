...
description: Complete catalog of all pair Knowledge Base guidelines (9 categories) and how-to guides (9 sequential steps).
---
...
| **Project Management Tools** | GitHub Projects, Linear, Jira configuration; [canonical states + state-mapping schema](/docs/concepts/canonical-states) |
