...
| **Project Management Tools** | GitHub Projects, Linear, Jira configuration; [canonical states + state-mapping schema](/docs/concepts/canonical-states); [Definition of Ready & Done](/docs/concepts/definition-of-ready-and-done) |
