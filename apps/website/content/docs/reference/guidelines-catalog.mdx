...
| 04 | **Define Subdomains** | subdomain, domain, DDD | `/pair-capability-map-subdomains` (scoped capability) |
| 05 | **Define Bounded Contexts** | bounded context, architecture, DDD | `/pair-capability-map-contexts` (scoped capability) |
