...
3. **Shallow clone** — `git clone --depth 1 [--branch ref] <url> <tempDir>`
4. **Install from clone** — copy dataset from temp dir to `~/.pair/kb/{version}/`
5. **Cleanup** — remove temp clone directory
