...
| **Capability** | 20 | Atomic units — perform a single focused operation (e.g., `/verify-quality`, `/record-decision`) |
...
- [Skills Catalog](/docs/reference/skills-catalog) — Full list of all 31 pair skills.
