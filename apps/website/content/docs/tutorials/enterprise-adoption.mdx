...
<Callout type="info">
  If publishing to npmjs.org as a public scoped package, consumers need no extra configuration — `npm install @your-org/your-cli` works out of the box. Publishing requires an npm access token with write scope.
</Callout>
