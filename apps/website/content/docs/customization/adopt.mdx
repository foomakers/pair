...
- **Adopting across several projects?** [External KB Repository](/docs/customization/external-kb) — keep the KB in its own versioned repository and install it everywhere, instead of adopting the same changes project by project.
