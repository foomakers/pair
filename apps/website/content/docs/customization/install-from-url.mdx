...
# SSH
pair install --source git@github.com:acme/kb-artifacts.git

# Pin to a tag or branch with #ref
pair install --source https://github.com/acme/kb-artifacts.git#v1.0.0
pair install --source git@github.com:acme/kb-artifacts.git#main
```
...
pair install --source https://github.com/acme/private-kb.git#v2.0.0
```
...
run: pair install --source https://github.com/acme/kb-artifacts.git#v1.0.0
```
