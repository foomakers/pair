...
pair ships with 13 templates that control the structure of workflow artifacts — from commit messages to user stories. This guide shows how to customize them for your team.
