...
pair ships with 14 templates that control the structure of workflow artifacts — from commit messages to user stories. This guide shows how to customize them for your team.
...
| Template | Used by | Controls |
| --- | --- | --- |
| **subdomain-template.md** | `/pair-capability-map-subdomains` | Subdomain definition: classification, Volatility, boundaries |
