...
- [FAQ](/docs/support/general-faq) — Common questions about pair, process, languages, and PM tools
- [Troubleshooting](/docs/support/troubleshooting) — Diagnostics and fixes for install and setup issues
...
1. **Check the Troubleshooting page first**: [Troubleshooting](/docs/support/troubleshooting) covers 80%+ of issues
...
- Review the [Troubleshooting](/docs/support/troubleshooting) page
