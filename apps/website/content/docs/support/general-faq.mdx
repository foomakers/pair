...
### Can I use pair-cli just to manage skills and assistant files — without the full Knowledge Base?

Yes. pair-cli works with any directory containing AGENTS.md and a `config.json`. Create a Git repository with your skills, write a config.json that defines the registries and targets, and distribute it with `pair install --source <git-url>`. No Knowledge Base required.

[Managing AI Artifacts tutorial](/docs/tutorials/managing-ai-artifacts)
