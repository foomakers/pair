...
pair supports four options: [Filesystem](/docs/pm-tools/filesystem) (backlog in your repo, no PM account — declare a [`code-host`](/docs/concepts/code-host) for the PRs), [GitHub Projects](/docs/pm-tools/github-projects) (free, great for teams on GitHub), [Linear](/docs/pm-tools/linear) (dedicated PM tool with a polished UI, hosts no code), and [Azure DevOps](/docs/pm-tools/azure-devops) (Boards + Repos, for the Microsoft ecosystem). You can switch between them at any time by updating `way-of-working.md`.
...
[Agent Integration](/docs/concepts/agent-integration) · [Adopter Checklist](/docs/getting-started/checklist)
