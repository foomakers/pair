...
- A central repository for your organization's Knowledge Base
- GitHub (for release distribution)
- Teams already using AI coding assistants

## Install pair-cli

Install pair-cli in the central KB repository:

```bash
npm install -g @pair/pair-cli
```

Verify with `pair-cli --version`.

## Set Up the Central Knowledge Base

Start with the default pair Knowledge Base:

```bash
pair-cli install
```

Then customize it for your organization:
