...
import { findDeadLinks, findDeadRepoLinks } from './repo-citations'

// Checks 5 and 5b — the link surface, the citation resolver, the github.com slugger and
// their lossless diagnostics — live in `./repo-citations` (one seam, one reason to
// change). Re-exported as the SAME bindings so every existing import of this module
