...
function consumeSection(identity: KbIdentity): string[] {
  return [
    ...
    '- **Release ZIP** — `pair-cli install --source <zip>` is not yet equivalent to the git',
    "  or path form: the ZIP is extracted into the official KB's shared cache slot. Publish",
    '  the ZIP as your release artifact, but point consumers at the repository or a clone',
    '  until this is fixed (<https://github.com/foomakers/pair/issues/395>).',
