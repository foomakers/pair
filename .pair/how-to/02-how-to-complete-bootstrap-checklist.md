...
2. Follow the [adopted standards requirements](../tech/adopted/README.md):
   ...
   - When adopting a project management tool, reference `/.pair/tech/knowledge-base/12-collaboration-and-process-guidelines/project-management-framework.md` for usage. Example: "Github Projects is adopted. See `/.pair/tech/knowledge-base/project-management-framework-github.md` for usage."
