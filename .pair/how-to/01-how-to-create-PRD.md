...
**AI Assistant Instructions:** You have access to the complete PRD template structure at [`.pair/assets/PRD_template.md`](../assets/PRD_template.md) and a practical example at [`.pair/assets/PRD_example.md`](../assets/PRD_example.md).

**Before starting the process, you must:**

1. **Review the template** ([`.pair/assets/PRD_template.md`](../assets/PRD_template.md)) to understand all required sections and their purpose
2. **Study the example** ([`.pair/assets/PRD_example.md`](../assets/PRD_example.md)) to understand the expected level of detail, writing style, and content quality
...
1. **Review [`./pair/assets/PRD_template.md`](../assets/PRD_template.md)** to understand the complete structure and requirements
2. **Study [`./pair/assets/PRD_example.md`](../assets/PRD_example.md)** to understand the expected quality, detail level, and writing style
...
1. **Copy the template** from [`.pair/assets/PRD_template.md`](.pair/assets/PRD_template.md) into [`.pair/product/adopted/PRD.md`](.pair/product/adopted/PRD.md)
2. **Replace all template placeholders** with the gathered information
3. **Match the quality standard** demonstrated in [`.pair/assets/PRD_example.md`](.pair/assets/PRD_example.md)
...
**Important:** The PRD must be created in [`.pair/product/adopted/PRD.md`](.pair/product/adopted/PRD.md) and will contain all subsequent revisions as you iterate with the developer.

### Step 6: Review and Iteration Process

**AI Assistant Instructions:** Present the draft PRD to the developer with this approach:

1. **Present the complete draft** from [`.pair/product/adopted/PRD.md`](.pair/product/adopted/PRD.md) for initial review
...
_"I've completed the first draft of your PRD in [`.pair/product/adopted/PRD.md`](.pair/product/adopted/PRD.md). Please review each section and provide feedback on:_
...
1. **Cross-reference with the template** from [`.pair/assets/PRD_template.md`](.pair/assets/PRD_template.md) to ensure no sections are missing
2. **Compare quality against the example** in [`.pair/assets/PRD_example.md`](.pair/assets/PRD_example.md) to ensure professional standards
...
6. **Ensure the final version is saved** in [`.pair/product/adopted/PRD.md`](.pair/product/adopted/PRD.md)

**Final Checklist:**

- [ ] All template sections completed per [`.pair/assets/PRD_template.md`](.pair/assets/PRD_template.md)
- [ ] Quality matches the standard of [`.pair/assets/PRD_example.md`](.pair/assets/PRD_example.md)
...
- [ ] Document is saved in [`.pair/product/adopted/PRD.md`](.pair/product/adopted/PRD.md)
...
- [ ] All information matches the specificity level of [`.pair/assets/PRD_example.md`](.pair/assets/PRD_example.md)
...
- [ ] All sections from [`.pair/assets/PRD_template.md`](.pair/assets/PRD_template.md) are completed
...
- [ ] Final document is properly saved in [`.pair/product/adopted/PRD.md`](.pair/product/adopted/PRD.md)
