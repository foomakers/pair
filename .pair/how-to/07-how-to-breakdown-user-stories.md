...
Before starting, **read and consult the User Story Template**: [User Story Template](../tech/knowledge-base/12-collaboration-and-process-guidelines/assets/user-story-template.md#initial-breakdown-template). All required structure and fields are defined in the template.
...
5. **Verify Selected Epic Completion**: Once epic is selected, check that it's fully documented with:
   ...
   - Complete epic [template](../tech/knowledge-base/12-collaboration-and-process-guidelines/assets/user-story-template.md#initial-breakdown-template) filled out
...
- Use the breakdown [template](../tech/knowledge-base/12-collaboration-and-process-guidelines/assets/user-story-template.md#initial-breakdown-template) provided in this guide
...
1. **Follow Tool-Specific Format**: Adapt breakdown [template](../tech/knowledge-base/12-collaboration-and-process-guidelines/assets/user-story-template.md#initial-breakdown-template) to tool requirements
...
- [ ] User story created with breakdown [template](../tech/knowledge-base/12-collaboration-and-process-guidelines/assets/user-story-template.md#initial-breakdown-template) information
...
- [ ] All required breakdown [template](../tech/knowledge-base/12-collaboration-and-process-guidelines/assets/user-story-template.md#initial-breakdown-template) sections completed
