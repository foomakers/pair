...
- Rationale: architectural and domain decisions form supersede chains and are referenced by number elsewhere (brainstorm/refine conflict flags, cross-references) — a chain reads more naturally as `adr-015 supersedes adr-012` than as date deltas. See ADL [2026-07-18-decision-record-naming-convention.md](../../../adoption/decision-log/2026-07-18-decision-record-naming-convention.md).
...
| ------------------ | -------------------------------------------------------- |
| `/pair-capability-record-decision` | Creates ADR, ADL, DDR, or an analysis-log entry; updates adoption files, context map, or adoption summary |
