...
| **Review** (`/pair-process-review`) | judgment on the change | a verdict (APPROVED / CHANGES-REQUESTED / TECH-DEBT) in the native code-host review | **zero mechanical checks** — it reads gate results, it never re-runs them |
