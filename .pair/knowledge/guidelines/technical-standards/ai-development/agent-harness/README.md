...
**Skill**: Use `/pair-capability-setup-harness` to resolve, verify the fitness of, and configure a harness for this project. See [way-of-working / harness + model-class schema](../../../collaboration/automation/automation-policy.md) for the adoption-side declaration.
