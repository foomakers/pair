...
| ------------------------- | ----------------------------------------------------------------------------------------------------- | ------------------- | ---------------------------------- |
| `specify-prd`             | [`01-how-to-create-PRD.md`](../../../how-to/01-how-to-create-PRD.md)                                    | `/pair-process-specify-prd`      | —                                  |
| `bootstrap`               | [`02-how-to-complete-bootstrap-checklist.md`](../../../how-to/02-how-to-complete-bootstrap-checklist.md) | `/pair-process-bootstrap`        | `specify-prd`                      |
| `brainstorm`              | —                                                                                                       | `/pair-process-brainstorm`       | —                                  |
| `plan-initiatives`        | [`03-how-to-create-and-prioritize-initiatives.md`](../../../how-to/03-how-to-create-and-prioritize-initiatives.md) | `/pair-process-plan-initiatives` | `specify-prd`            |
| `define-subdomains`       | —                                                                                                       | `/pair-capability-map-subdomains`   | —                                  |
| `define-bounded-contexts` | —                                                                                                       | `/pair-capability-map-contexts`     | `define-subdomains`                |
| `plan-epics`              | [`06-how-to-breakdown-epics.md`](../../../how-to/06-how-to-breakdown-epics.md)                          | `/pair-process-plan-epics`       | `plan-initiatives`, `brainstorm`   |
| `plan-stories`            | [`07-how-to-breakdown-user-stories.md`](../../../how-to/07-how-to-breakdown-user-stories.md)            | `/pair-process-plan-stories`     | `plan-epics`, `brainstorm`         |
| `refine-story`            | [`08-how-to-refine-a-user-story.md`](../../../how-to/08-how-to-refine-a-user-story.md)                  | `/pair-process-refine-story`     | `plan-stories`                     |
| `plan-tasks`              | [`09-how-to-create-tasks.md`](../../../how-to/09-how-to-create-tasks.md)                                | `/pair-process-plan-tasks`       | `refine-story`                     |
| `implement`               | [`10-how-to-implement-a-task.md`](../../../how-to/10-how-to-implement-a-task.md)                        | `/pair-process-implement`        | `plan-tasks`                       |
| `review`                  | [`11-how-to-code-review.md`](../../../how-to/11-how-to-code-review.md)                                  | `/pair-process-review`           | `implement`                        |

## The three asymmetries, as declared data

Every asymmetry below is a cell in the table above — not a conditional in `/pair-next` and not a special case in any skill. That is the whole point of the catalogue: the same three facts handled as logic would be three branches to keep in step across `/pair-next` and twelve step skills.
...
| ----------------------------- | ------------------------------------------------------------------------------------------- |
| `/pair-capability-estimate`, `/pair-capability-classify`      | Composed inside a step (refinement); a team does not "decide not to size stories" as a phase |
| `/pair-capability-verify-quality`, `/pair-capability-verify-done` | Quality mechanics that apply to whatever process runs                                    |
| `/pair-capability-record-decision`, `/pair-capability-write-issue` | Writers composed by steps; disabling one would break every step that composes it        |
| `/pair-next`, `/pair-loop`              | Navigators — they READ the profile, they are not governed by it                              |
