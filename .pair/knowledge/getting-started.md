...
- **`skills-guide.md`**: Full catalog of 37 Agent Skills (9 process + 27 capability + 1 navigator) with composition patterns, adoption file mapping, and usage instructions
