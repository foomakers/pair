...
- **`skills-guide.md`**: Full catalog of 35 Agent Skills (9 process + 25 capability + 1 navigator) with composition patterns, adoption file mapping, and usage instructions
