...
- **`skills-guide.md`**: Full catalog of 36 Agent Skills (9 process + 26 capability + 1 navigator) with composition patterns, adoption file mapping, and usage instructions
