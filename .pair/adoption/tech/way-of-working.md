...
- **No step reachable from the gate writes files** (formatters and eslint autofix alike): the gate reports, `pnpm format` / `pnpm lint:fix` fix deliberately. See ADL [2026-07-31-pre-push-gate-is-check-only.md](../decision-log/2026-07-31-pre-push-gate-is-check-only.md).
