...
- `pair-cli` is the sole canonical CLI invocation name — no `pair` bin alias exists or is planned. See ADL [2026-08-25-cli-invocation-canonical-name-is-pair-cli.md](../decision-log/2026-08-25-cli-invocation-canonical-name-is-pair-cli.md). The name is **enforced**, not just documented: the website's `docs:staleness` gate (`apps/website/lib/docs-staleness-check.ts`) errors on a bare `pair <cmd>` invocation in any published docs page, and the rename it enforces covers every surface that documents or prints an invocation — see ADL [2026-08-30-docs-staleness-invocation-rule-and-repo-wide-pair-cli-sweep.md](../decision-log/2026-08-30-docs-staleness-invocation-rule-and-repo-wide-pair-cli-sweep.md).
