...
1. [🤝 Collaboration Principles](#-collaboration-principles)
2. [💬 Communication Standards](#-communication-standards)
3. [🛠️ Development Workflow](#️-development-workflow)
4. [👥 Roles and Responsibilities](#-roles-and-responsibilities)
5. [⚖️ Decision-Making & Conflict Resolution](#-decision-making--conflict-resolution)
6. [🏡 Remote & Hybrid Work](#-remote--hybrid-work)
7. [🗂️ Project Management Framework](#️-project-management-framework)
8. [📊 Initiative Management](#-initiative-management)
9. [🎯 Epic Management](#-epic-management)
10. [📝 User Story Management](#-user-story-management)
11. [✅ Task Management](#-task-management)
12. [📋 Code Review Management](#-code-review-management)
13. [🔄 Continuous Improvement](#-continuous-improvement)
14. [📋 Compliance & Quality Assurance](#-compliance--quality-assurance)
...
#### GitHub Projects-Based Management
...
#### GitHub Projects-Based Initiative Management

1. **Field Mapping and Template Adaptation**

   - Create GitHub Project issue with initiative template content
...
2. **Automation and Creation**
   ...
   - Use GitHub CLI (`gh`) or GitHub Projects automation
...
> “When creating initiatives in GitHub Projects, use the label `initiative` and assign the issue type `Feature`. If the label does not exist, create it first.
> Assign all template fields to the appropriate GitHub issue/project fields. Prefer direct creation via GitHub CLI if possible.”

This makes the process reproducible, minimizes back-and-forth, and ensures the AI can act autonomously with all needed context.
...
```markdown
# Epic [Initiative-Code]-[Epic-Number]: [Epic Name]
...
#### GitHub Projects-Based Epic Management

1. **Issue Creation and Labeling**

   - Create epic as GitHub issue with full template content
   - Apply labels: `epic`, initiative code, priority, status
...
#### GitHub Projects-Based User Story Management

1. **Issue Management**

   - Create user story as GitHub issue with template content
   - Apply labels: `user-story`, epic code, priority, story points, status
...
3. **Task Integration Options**

   **Option 1: Separate Task Issues**

   - Create tasks as separate GitHub issues with detailed descriptions
   - Apply labels: `task`, user story code, technical area, priority
   - Link to parent user story, epic, and initiative issues
   - Track granular task progress and connect to pull requests

   **Option 2: Tasks Within User Story Issues**

   - Add task breakdown as checklist items within the user story issue
   - Use GitHub's task list functionality for tracking completion
   - Reference technical standards and bounded contexts in issue comments
...
#### GitHub Projects-Based Task Management
...
2. **Development Integration**
   - Connect tasks to pull requests and commits
   - Track task progress through development states
   - Update completion status automatically through PR merges
...
#### GitHub Projects-Based Review Management

- Create review follow-up tasks as linked issues or checklist items
- Apply appropriate labels for tracking and filtering
- Use automation to update story and epic status based on review task completion
