...
1. **Top-Down Planning:** Start with initiatives and epics, then break down systematically to user stories and tasks. Task breakdown only after user story refinement.
...
2. **Creation and Linking Process**
   - Create user stories from epics using the User Story breakdown template
   ...
   - Append task breakdown directly to refined user story body (no separate task files)
