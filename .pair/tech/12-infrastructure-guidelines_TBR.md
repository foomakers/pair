...
- **[Architectural Guidelines](./01-architectural-guidelines_TBR.md)** - High-level architecture and bounded context design
- **[Security Guidelines](./09-security-guidelines_TBR.md)** - Security implementation and practices
- **[Observability Guidelines](./10-observability-guidelines_TBR.md)** - Monitoring and logging strategies
- **[Performance Guidelines](./08-performance-guidelines_TBR.md)** - Performance optimization and requirements
