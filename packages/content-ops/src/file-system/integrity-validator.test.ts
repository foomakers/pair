...
describe('Integrity Validator - SHA256 Calculation', () => {
  it('calculates SHA256 hash of file content', async () => {
    ...
    const fs = new InMemoryFileSystemService({ '/tmp/test.txt': content }, '/', '/')
  ...
  it('calculates hash for binary content', async () => {
    ...
    const fs = new InMemoryFileSystemService({ '/tmp/binary.dat': content.toString() }, '/', '/')
...
describe('Integrity Validator - Validation', () => {
  it('validates correct checksum', async () => {
    ...
    const fs = new InMemoryFileSystemService({ '/tmp/file.zip': content }, '/', '/')
...
describe('Integrity Validator - Integration', () => {
  it('validates downloaded file against checksum', async () => {
    ...
    const fs = new InMemoryFileSystemService({ '/tmp/kb.zip': content }, '/', '/')
