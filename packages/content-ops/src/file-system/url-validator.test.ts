...
import { validateUrl, isValidHttpUrl } from './url-validator'
...
describe('URL Validator', () => {
  ...
  describe('validateUrl', () => {
    ...
    it('throws error for invalid protocol', () => {
      expect(() => validateUrl('file:///path/kb.zip')).toThrow('Invalid URL protocol')
      expect(() => validateUrl('file:///path/kb.zip')).toThrow('Only http:// and https://')
    })
    ...
    it('provides helpful error message', () => {
      expect(() => validateUrl('ftp://example.com/kb.zip')).toThrow(
