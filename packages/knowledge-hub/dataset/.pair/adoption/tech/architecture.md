...
This document contains the **validated architectural decisions** for the project. It serves as the authoritative reference for all architectural patterns, system boundaries, and design principles that have been proposed by AI and validated by the development team during the **Strategic Preparation** phase outlined in the [way-of-working.md](.pair/knowledge/way-of-working.md).
