...
- **`skills-guide.md`**: Full catalog of 38 Agent Skills (9 process + 28 capability + 1 navigator) with composition patterns, adoption file mapping, and usage instructions
