...
- **`skills-guide.md`**: Full catalog of 50 Agent Skills (10 process + 32 capability + 6 workflow + 2 navigator) with composition patterns, adoption file mapping, and usage instructions
