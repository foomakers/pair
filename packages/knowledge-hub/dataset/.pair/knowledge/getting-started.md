...
- **`skills-guide.md`**: Full catalog of 44 Agent Skills (10 process + 32 capability + 2 navigator) with composition patterns, adoption file mapping, and usage instructions
