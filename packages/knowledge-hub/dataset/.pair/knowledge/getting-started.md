...
- **`skills-guide.md`**: Full catalog of 55 Agent Skills (10 process + 32 capability + 11 workflow + 2 navigator) with composition patterns, adoption file mapping, and usage instructions
