...
**Skill**: Use `/assess-infrastructure` to evaluate and adopt infrastructure decisions from these guidelines via the resolution cascade. Use `/assess-observability` for the observability section.
