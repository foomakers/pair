...
gh issue create \
  ...
  --body-file .pair/tech/knowledge/12-collaboration-and-process-guidelines/assets/initiative-template.md \
  --label "initiative,P0" \
  --assignee @me
```
...
gh issue create \
  ...
  --body-file .pair/tech/knowledge/12-collaboration-and-process-guidelines/assets/epic-template.md \
...
gh issue create \
  ...
  --body-file .pair/tech/knowledge/12-collaboration-and-process-guidelines/assets/user-story-template.md \
