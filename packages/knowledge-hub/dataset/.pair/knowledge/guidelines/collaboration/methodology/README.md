...
- **[methodology-selection-guide.md](methodology-selection-guide.md)** - Context-based methodology selection
  - Decision matrix based on team size, project complexity, organizational culture
  - Hybrid approaches and methodology combinations
  - AI-assisted project management considerations
