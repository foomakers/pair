...
Define fundamental design principles for clear, readable, and maintainable code that supports long-term development efficiency.

## Scope

**In Scope:**

- Code clarity and readability principles
...
- Framework-specific implementations (see [Framework Patterns](../framework-patterns/))
- Quality enforcement tools (see [Quality Standards](../quality-standards/))
- Organizational patterns (see [Organization Patterns](../organization-patterns/))
...
function calc(u: User, r: number): number {
  ...
  return u.items.reduce((sum, item) => sum + item.price * item.qty, 0) * (1 + r)
}
...
- ✅ Self-documenting code standards implemented
- ✅ Consistent patterns applied
- ✅ Maintainable design practices followed

## � Related Documents

Core implementation guides:

- **[Framework Patterns](../framework-patterns/)** - _Applies these principles to specific frameworks_
- **[Quality Standards](../quality-standards/)** - _Enforces these principles through automation_
- **[Implementation Standards](../implementation-standards/)** - _Practical application of design principles_
- **[Organization Patterns](../organization-patterns/)** - _Structures code following these principles_

Supporting references:

- **[Architecture Guidelines](../../architecture/README.md)** - _System-level design principles_
- **[Technical Standards](../technical-standards/README.md)** - _Technology choices supporting these principles_
...
type UserService = {
  ...
  readonly updateUser: (id: UserId, data: UpdateUserData) => Promise<Result<User>>
}
...
For comprehensive accessibility standards and ESLint integration, see [Accessibility Guidelines](.pair/knowledge/guidelines/quality/accessibility/accessibility-guidelines.md) which provides:

- Complete `react-a11y.js` extension with jsx-a11y plugin rules
- WCAG compliance rules integration
- Accessibility-specific linting standards aligned with [UX Guidelines](.pair/knowledge/guidelines/operations/ux-design/ux-guidelines.md)
...
export default defineConfig({
  test: {
    coverage: {
      ...
      include: ['src/services/**/*.ts', 'src/utils/**/*.ts', 'src/components/**/*.tsx'],
    },
  },
})
```
...
const addUser = (users: UserRepository, user: User): UserRepository => [...users, user]
...
- **[Architectural Guidelines](.pair/knowledge/guidelines/architecture/system-design/README.md)** - _Architectural patterns guide code organization_
- **[Technical Guidelines](.pair/knowledge/guidelines/development/technical-standards/technical-guidelines.md)** - _Technology stack enables implementation_
- **[UX Guidelines](.pair/knowledge/guidelines/operations/ux-design/ux-guidelines.md)** - _UI standards complement React patterns_

Supporting documents:

- **[Testing Strategy](.pair/knowledge/guidelines/development/testing/testing-strategy.md)** - _Testing approaches verify code quality_
- **[Definition of Done](.pair/knowledge/guidelines/quality/standards/definition-of-done.md)** - _Quality criteria validate code standards_
