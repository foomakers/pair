...
- **[Decision Records](.pair/knowledge/guidelines/architecture/decision-records/README.md)** - ADR process for DDD decisions
- **[Code Design](.pair/knowledge/guidelines/development/code-design/README.md)** - Implementation patterns for DDD
