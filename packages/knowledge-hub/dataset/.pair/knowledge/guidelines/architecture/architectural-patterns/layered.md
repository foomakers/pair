...
- **[Hexagonal Architecture](architectural-patterns-hexagonal.md)** - Dependency inversion evolution
- **[Clean Architecture](architectural-patterns-clean.md)** - Advanced layered approach
