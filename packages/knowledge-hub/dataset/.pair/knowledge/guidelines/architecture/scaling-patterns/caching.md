...
export class UserService {
  constructor(private userRepository: UserRepository, private cache: CacheManager) {}
...
- [Database Read Replicas](database-read-replicas.md) - Database scaling
- [CQRS Scaling](cqrs.md) - Command-query separation
- [Performance Optimization](.pair/knowledge/guidelines/architecture/performance-patterns/README.md) - Overall performance strategies
