...
- [Functional boundaries affecting pull request scope](.pair/adoption/product/subdomain)
- [Technical boundaries affecting code review](.pair/adoption/tech/boundedcontext)
