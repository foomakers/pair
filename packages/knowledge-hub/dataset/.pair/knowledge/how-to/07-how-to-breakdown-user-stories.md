...
Before starting, **read and consult the User Story Template**: [User Story Template](.pair/knowledge/guidelines/12-collaboration-and-process-guidelines/assets/user-story-template.md). All required structure and fields are defined in the template.
...
5. **Verify Selected Epic Completion**: Once epic is selected, check that it's fully documented with:
   ...
   - Complete epic [template](.pair/knowledge/guidelines/12-collaboration-and-process-guidelines/assets/user-story-template.md) filled out
...
- Use the breakdown [template](.pair/knowledge/guidelines/12-collaboration-and-process-guidelines/assets/user-story-template.md) provided in this guide
...
1. **Follow Tool-Specific Format**: Adapt breakdown [template](.pair/knowledge/guidelines/12-collaboration-and-process-guidelines/assets/user-story-template.md) to tool requirements
...
- [ ] User story created with breakdown [template](.pair/knowledge/guidelines/12-collaboration-and-process-guidelines/assets/user-story-template.md) information
...
- [ ] All required breakdown [template](.pair/knowledge/guidelines/12-collaboration-and-process-guidelines/assets/user-story-template.md) sections completed
