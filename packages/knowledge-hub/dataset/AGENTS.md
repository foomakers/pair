...
- **Record decisions** - architectural/project decisions MUST be recorded as ADR or ADL. Use `/record-decision` skill or write to `.pair/adoption/tech/adr/` (architectural) / `.pair/adoption/decision-log/` (non-architectural).
