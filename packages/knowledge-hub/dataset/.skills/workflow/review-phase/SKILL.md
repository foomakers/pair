...
| `$synthesisMarker`  | Yes      | `<!-- pair:synthesis #<story> PR#<n> run:<run> -->` — line 1 of the ONE remediation synthesis of this run, edited in place on every convergence.               |
