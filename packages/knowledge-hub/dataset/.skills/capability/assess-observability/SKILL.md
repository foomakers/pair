...
description: "Assess observability strategy using resolution cascade (Argument > Adoption > Assessment). Reads observability guidelines, proposes monitoring/logging/tracing choices, writes infrastructure.md observability section, composes /record-decision. Idempotent."
version: 0.4.1
author: Foomakers
---
...
| Skill              | Type       | Required                                              |
| ------------------ | ---------- | ----------------------------------------------------- |
| `/record-decision` | Capability | Yes — records observability decision as ADR or ADL    |
...
1. **Act**: Write or update **only the observability section** of [infrastructure.md](../../../.pair/adoption/tech/infrastructure.md):
   ...
   - Preserve all other sections (owned by /assess-infrastructure)
2. **Act**: If infrastructure.md doesn't exist, create it with observability section. Warn: "Created infrastructure.md — core sections should be populated by /assess-infrastructure."
