...
description: "Records a decision — ADR (architectural), ADL (non-architectural), or DDR (domain, 3-criteria gate) — and is the sole writer of adoption/context-map files. Invoke directly to record or backfill a decision already made ('write that down as an ADR'). Composed by /implement and /review."
version: 0.5.0
author: Foomakers
---
