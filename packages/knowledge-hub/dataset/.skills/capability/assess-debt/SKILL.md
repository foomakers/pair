...
name: assess-debt
description: >-
  Flags technical debt items with severity levels. Stub implementation — detects
  and flags debt without categorization or prioritization formula. Full
  implementation in a future story. Invocable independently or composed by
  /review.
---
