...
- If `/write-issue` is not installed, warn and provide formatted story content for manual PM tool entry.
...
- After story creation, proceed to `/refine-story` for detailed specification.
