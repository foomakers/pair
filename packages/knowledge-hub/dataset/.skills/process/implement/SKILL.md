...
3. **Act**: Read the story from the PM tool (per `adoption/tech/way-of-working.md`).
...
3. **Act**: Read:
   - `adoption/tech/architecture.md` — architectural patterns
   - `adoption/tech/tech-stack.md` — approved libraries and versions
   - `adoption/tech/way-of-working.md` — development process
...
1. **Check**: Did the implementation introduce any new dependency not listed in `adoption/tech/tech-stack.md`?
...
3. **Act**: Is `/assess-stack` installed?
   ...
   - **No**: Warn the developer:
     > New dependency detected: `[package@version]`. `/assess-stack` is not installed — please manually verify against the tech stack and update `adoption/tech/tech-stack.md`.
...
3. **Act**: Stage and commit following the commit template (`collaboration/templates/commit-template.md`):
   ```
...
3. **Act**: Create PR following the PR template (`collaboration/templates/pr-template.md`):
...
- Commit messages follow `collaboration/templates/commit-template.md`.
- PR description follows `collaboration/templates/pr-template.md`.
