const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/Button-DqwVb5yk.js","assets/jsx-runtime-Dz1ZLmT7.js","assets/Callout-_34TRt9n.js","assets/Card-CCAW15wH.js","assets/Logo-CUgdGdzJ.js"])))=>i.map(i=>d[i]);
...
function requireScheduler_production () {
	...
	(function (exports$1) {
		...
		function shouldYieldToHost() {
		  return exports$1.unstable_now() - startTime < frameInterval ? !1 : !0;
		}
...
const _Users_gianlucacarucci_projects_pair_packages_brand_src_components_Button_Button = () => __vitePreload(() => import('./Button-DqwVb5yk.js'),true              ?__vite__mapDeps([0,1]):void 0).then((mod) => mod.Button);
const _Users_gianlucacarucci_projects_pair_packages_brand_src_components_Callout_Callout = () => __vitePreload(() => import('./Callout-_34TRt9n.js'),true              ?__vite__mapDeps([2,1]):void 0).then((mod) => mod.Callout);
const _Users_gianlucacarucci_projects_pair_packages_brand_src_components_Card_Card = () => __vitePreload(() => import('./Card-CCAW15wH.js'),true              ?__vite__mapDeps([3,1]):void 0).then((mod) => mod.Card);
const _Users_gianlucacarucci_projects_pair_packages_brand_src_components_Logo_PairLogo = () => __vitePreload(() => import('./Logo-CUgdGdzJ.js'),true              ?__vite__mapDeps([4,1]):void 0).then((mod) => mod.PairLogo);
__pwRegistry.initialize({ _Users_gianlucacarucci_projects_pair_packages_brand_src_components_Button_Button,
  _Users_gianlucacarucci_projects_pair_packages_brand_src_components_Callout_Callout,
  _Users_gianlucacarucci_projects_pair_packages_brand_src_components_Card_Card,
  _Users_gianlucacarucci_projects_pair_packages_brand_src_components_Logo_PairLogo });

export { getDefaultExportFromCjs as g };
//# sourceMappingURL=index-BYMZIHiV.js.map
