...
2. **Act**: For each finding, tag it **introduced** (new code/change in this diff) or **pre-existing** (surfaced, not a reason to block on its own — AC4 only fires on introduced vulnerabilities).
