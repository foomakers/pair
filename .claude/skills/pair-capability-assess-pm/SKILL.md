...
Follows the [Decision Shape](../../../.pair/knowledge/skill-conventions/output-shapes.md#decision-shape) (with a `Delegated` status for the /pair-capability-setup-pm handoff — a legitimate per-skill variant, see that file).
