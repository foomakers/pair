...
| `$contract` | Yes      | Absolute path of the RED contract JSON written by `/pair-workflow-red-spec` (it lives in the main checkout's run directory, not in the worktree). |
